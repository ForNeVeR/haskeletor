...
if "%WIN_ARCH%" equ "AMD64" (
    set JVM_TARGET_DIR=%BUILD_DIR%\amazon-corretto-17-x64-windows-jdk-aca311\
    set JVM_URL=https://corretto.aws/downloads/latest/amazon-corretto-17-x64-windows-jdk.zip
